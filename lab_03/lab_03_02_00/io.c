...
/**
 * @brief Функция обработки ввода цифры
 * @param[out] digit
 * @return Код ошибки 
*/
int input_digit(short *digit)
{
