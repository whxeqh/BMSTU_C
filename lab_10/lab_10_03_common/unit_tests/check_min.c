...
START_TEST(arr_one_elem)
{
    ...
    rc = assoc_array_min(ass_arr, &value);

    ck_assert_int_eq(rc, ASSOC_ARRAY_OK);
    ck_assert_int_eq(*value, min_elem.value);
...
START_TEST(arr_two_elems)
{
    ...
    data_t data_arr[] = { { "b", 10 }, { "a", 20 }, };
    data_t min_elem = data_arr[1];
    int *value;
...
START_TEST(arr_six_elems)
{
    ...
    data_t data_arr[] = { { "t", 10 }, { "c", 20 }, { "d", 30 }, { "a", 40 }, { "e", 50 }, { "b", 50 } };
    data_t min_elem = data_arr[3];
    int *value;
...
START_TEST(find_in_begin)
{
    ...
    data_t data_arr[] = { { "a", 10 }, { "c", 20 }, { "d", 30 }, { "e", 40 }, { "f", 50 } };
    data_t min_elem = data_arr[0];
    int *value;
...
START_TEST(find_in_mid)
{
    ...
    data_t data_arr[] = { { "f", 10 }, { "c", 20 }, { "b", 30 }, { "e", 40 }, { "d", 50 } };
    data_t min_elem = data_arr[2];
    int *value;
...
START_TEST(find_in_end)
{
    ...
    data_t data_arr[] = { { "f", 10 }, { "c", 20 }, { "d", 30 }, { "e", 40 }, { "b", 50 } };
    data_t min_elem = data_arr[4];
    int *value;
...
START_TEST(num_null)
{
    ...
    rc = assoc_array_min(ass_arr, NULL);
...
Suite *test_assoc_array_min(void)
{
    Suite *suite;
    TCase *tc_pos, *tc_neg;

    suite = suite_create("assoc_array_min");
